...
CREATE TABLE `venta` (
  ...
  `fechaApartadoFinal` date DEFAULT NULL,
  `pagoApartado` float NOT NULL,
  `comentarios` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
-- Dump completed on 2021-01-30 15:46:30
