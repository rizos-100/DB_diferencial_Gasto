...
CREATE TABLE `detalleVenta` (
  ...
  CONSTRAINT `detalleVenta_ibfk_2` FOREIGN KEY (`idArticuloColorTalla`) REFERENCES `articuloColorTalla` (`idArticuloColorTalla`)
...
INSERT INTO `detalleVenta` VALUES (1,1,0,1,1),(2,1,0,2,2),(3,1,0,3,2);
...
-- Dump completed on 2021-01-30 15:46:48
